...
opt.grepprg = "rg --vimgrep --no-heading --smart-case" -- pass --hidden to search multifile
...
-- Enable default nvim plugins
--@see https://neovim.io/doc/user/plugins
vim.cmd.packadd("nvim.undotree")
vim.cmd.packadd("nvim.difftool")
--vim.cmd.packadd("nvim.justify")
